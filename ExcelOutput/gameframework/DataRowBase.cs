 ...
 namespace UnityGameFramework.Runtime
{
    ...
    public abstract class DataRowBase : IDataRow
    {
        ...
        {
            Console.WriteLine("Not implemented ParseDataRow(string dataRowString, object userData).");
            return false;
        }
        ...
        {
            Console.WriteLine("Not implemented ParseDataRow(byte[] dataRowBytes, int startIndex, int length, object userData).");
            return false;
        }
    }
}
